...
(() => {
  ...
  class ImageSlot extends HTMLElement {
    ...
    _render() {
      ...
      // Content. The sidecar is also writable by tooling, so its value isn't
      // guaranteed canvas-originated. Only accept data:image/ URLs from it.
      // The `src` attribute is author-controlled, so it passes through unchanged.
